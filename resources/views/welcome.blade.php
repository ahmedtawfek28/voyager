                                    ...
                                    <ul class="nav nav-pills">
                                            {{-- <li class="dropdown flags">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownLanguage">
                                                            <a class="dropdown-item" href="https://blog.tawfek.tk/ar"><img
                                            ...
                                            <li>
                                                <a rel="alternate" hreflang="{{ $localeCode }}"
                                                   href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                                   @php
                                                //    dd(substr($properties['regional'], 0, 2));
                                               // dd(app()->getLocale());
                                                   @endphp
                                                   @if(substr($properties['regional'], 0, 2)==app()->getLocale())
                                                   {{ $properties['native'] }}</strong>
                                        ...
                                        <li class="nav-item nav-item-left-border nav-item-left-border-remove nav-item-left-border-sm-show">
                                            <span class="ws-nowrap"><i class="fas fa-map-marker-alt"></i> Tolba Awida ST-Beside Salah Salem Hospital-ElKawmia-Zagazig</span>
                                        </li>
            ...
            <div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider
                ...
                <ul>
                    ...
                    <li class="slide-overlay" data-transition="fade">
                        <img src="{{ asset('FrontEnd/img/demos/digital-agency/slides/slide-digital-agency-2.jpg') }}"
                             alt=""
                        ...
                        <div class="tp-caption"
                             ...
                             data-transform_idle="opacity:0.2;s:500;"><img src="{{ asset('FrontEnd/img/slides/slide-title-border.png') }}"
                                                                           alt=""></div>
                    ...
                    <li class="slide-overlay" data-transition="fade">
                        <img src="{{ asset('FrontEnd/img/demos/digital-agency/slides/slide-digital-agency-3.jpg') }}"
                             alt=""
                             data-bgposition="center center"
                             data-bgfit="cover"
                             data-bgrepeat="no-repeat"
                        ...
                        <div class="tp-caption text-color-light font-weight-normal"
                             ...
                             data-fontsize="['16','16','16','40']"
                             data-lineheight="['25','25','25','45']"
                             data-transform_in="y:[-50%];opacity:0;s:500;">نحن نعمل علي الافضل
                        </div>
                        ...
                        <div class="tp-caption font-weight-extra-bold text-color-light negative-ls-1"
                             ...
                             data-y="center"
                             data-fontsize="['50','50','50','90']"
                             data-lineheight="['55','55','55','95']">افضل شكل
                        </div>

                        <div class="tp-caption font-weight-light ws-normal text-center"
                             data-frames='[{"from":"opacity:0;","speed":3000,"to":"o:1;","delay":2000,"ease":"Power2.easeInOut"},{"delay":"wait","speed":1000,"to":"y:[100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]'
                             data-x="center"
                             data-y="center" data-voffset="['60','60','60','105']"
                             data-width="['530','530','530','1100']"
                             data-fontsize="['18','18','18','40']"
                             data-lineheight="['26','26','26','45']"
                             style="color: #b5b5b5;">نحن موثوقين من خلال 3000 عميل سعيد ومن خلال ذلك فانا ارجح هذا العمل
                        </div>
